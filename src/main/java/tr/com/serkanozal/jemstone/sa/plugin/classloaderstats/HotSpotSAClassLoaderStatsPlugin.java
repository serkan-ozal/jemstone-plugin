...
public class HotSpotSAClassLoaderStatsPlugin
        implements HotSpotServiceabilityAgentPlugin<NoHotSpotServiceabilityAgentParameter, 
                                                    HotSpotSAKeyValueResult, 
                                                    HotSpotSAClassLoaderStatsWorker> {

    public static final String PLUGIN_ID = "HotSpot_ClassLoader_Stats_Finder";
    ...
    @Override
    public HotSpotSAClassLoaderStatsWorker getWorker() {
        return new HotSpotSAClassLoaderStatsWorker();
    }
